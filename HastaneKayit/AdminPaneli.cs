    ...
    public partial class AdminPaneli : Form
    {
        ...
        private void btnKlinikSil_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //SİL KLİNİK
                frm1.uyelerBaglantisi.Open();//www.gorselprogramlama.com
                ...
                frm1.uyelerBaglantisi.Close();//www.gorselprogramlama.com
                KlinikleriGetir();
                listBoxDoktor.Items.Clear();
        ...
        void kullaniciAdi_Kontrolu()
        {
            ...
            try
            {
                ...
                if (rd.Read())
                {
                    MessageBox.Show("Bu Kullanıcı Adı / Kodu Daha Önce Alınmış"); //// UYELERİN KULLANICI ADI KONTROL EDİLDİ
                    kullaniciAdiKontroluTammammi = false;
                }
                else
                {
                    kullaniciAdiKontroluTammammi = true;//www.gorselprogramlama.com
                }
        ...
        private void DoktorEkleTamam_Click(object sender, EventArgs e)
        {
            ...
            if (kullaniciAdiKontroluTammammi == true)
            {
                ...
                {
                    MessageBox.Show(hata.Message);//www.gorselprogramlama.com
                }
        ...
        void UyeleriGetir()
        {
            ...
            try
            {
                ...
                while (rd.Read())
                {
                    ...
                    listView1.Items[i].SubItems.Add(rd["Cinsiyeti"].ToString());//www.gorselprogramlama.com
                    i++;
                }
                frm1.uyelerBaglantisi.Close();
            }
        ...
        private void btnUyeSil_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                frm1.uyelerBaglantisi.Close();
                UyeleriGetir();//www.gorselprogramlama.com
                uye_Sayisi = 0;
                uyeSayisiHesapla();
            }
            catch (Exception hata)
        ...
        private void btnBanla_Click(object sender, EventArgs e)
        {
            ...
            banGunu = numericUpDown1.Value.ToString();//www.gorselprogramlama.com
            if (banlanacakTC != "")
            {
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
             ...
             {
                 ListViewItem itm = listView1.SelectedItems[0];
                 TC = itm.SubItems[0].Text;//www.gorselprogramlama.com
             }
