    ...
    public partial class uyeGuncelle : Form
    {
        ...
        private void uyeGuncelle_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (rd.Read())
                {
                    ...
                    txtEpostaTekrar.Text = txtEposta.Text;//www.gorselprogramlama.com
                    txtParola.Text = "";
                    ...
                    else
                    {
                        ...
                        radioButton2.Checked = false;//www.gorselprogramlama.com
                    }
                }
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (txtEskiParola.Text==Parola)
            {
                ...
                {
                    errorProviderPAROLA.SetError(txtParola, "Parolala Eşleşmiyor");//www.gorselprogramlama.com
        ...
        void texboxlarEnteraBasinca()
        {
            foreach (Control txt in this.Controls)
            {
                ...
                {
                    txt.Text = "1";
                    txt.Text = "";//www.gorselprogramlama.com
                }
            }
        }
        ...
        void KontrollerPasif()
        {
            ...
            {
                asd.Enabled = false;//www.gorselprogramlama.com
            }
        }
