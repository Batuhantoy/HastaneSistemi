...
namespace HastaneKayit
{
    public partial class AlinanRandevular : Form
    {
        ...
        void listviewGuncelle()//www.gorselprogramlama.com
        {
        ...
        void renklendir()
        {
            ...
            string saatSimdi = date.ToShortTimeString();//www.gorselprogramlama.com
            ...
            for (int i = 0; i < listView1.Items.Count; i++)
            {
                ...
                {
                    listView1.Items[i].BackColor = Color.LawnGreen;//www.gorselprogramlama.com
                }
            }
        }
